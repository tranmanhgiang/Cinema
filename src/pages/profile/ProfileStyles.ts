...
export default StyleSheet.create({
    ...
    infoLastItem: { flexDirection: 'row', paddingVertical: 5 },
    userName: {
    ...
    info: { width: (2 * SCREEN_WIDTH) / 3, color: Colors.gray, fontSize: FontSize.normal, justifyContent: 'center' },
    phoneCode: { position: 'absolute', top: 14, fontSize: FontSize.normal, color: Colors.gray },
    text: { color: Colors.gray, fontSize: FontSize.normal },
    phone: { color: Colors.gray, paddingLeft: 30 },
